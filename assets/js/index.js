  ...
  $.fn.extend({
    cardify: function() {
      return this.each(function() {
        ...
        console.log(this);
        $(this).find('figure').css({'width': '100%', 'display': 'inline-block', 'color': 'white'});
        $('.text').hide();
        $(this).find('figure').mouseover(function() {
          ...
          $(this).find('img').css({'filter': 'brightness(30%)', '-webkit-filter': 'brightness(30%)'});
        ...
        $(this).find('figure').mouseleave(function(event) {
          ...
          $(this).find('figure').css({'display': 'none', 'background-color':'transparent'});
          $(this).find('img').css({'filter': 'brightness(100%)', '-webkit-filter': 'brightness(100%)'}); 
        });
      });
    }
  });
